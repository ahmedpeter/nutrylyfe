...
const ProductDetails = () => {
  ...
  const getProductDetails = async () => {
    ...
    const response = await query({
      method: "GET",
      url: `/admin/admin-products/get-single?product_id=1",
        ...
        <div class="col-xl-6 col-md-12  bg-white">
          <div class="ms-panel shadow-none ms-panel-fh">
            <div class="ms-panel-body pb-0">
              ...
              <p className="my-lg">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
