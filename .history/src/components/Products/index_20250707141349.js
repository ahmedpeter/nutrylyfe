...
<div class="ms-panel-body">
              ...
              {productList?.map((product, i) => (
                <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                  <span class="badge badge-danger">{currency(product.price)}</span>
                    <div class="ms-card-img">
                      <img src={`https://api.nutry-lyfe.pmall.com.ng/api`+product.image} alt={product.name}/>
                    </div>
                    <div class="ms-card-body">
                      <h6>{product.name}
                      </h6>
                      <p>{product.description}</p>
                      <a href="add-product.html#" class="btn btn-primary btn-block">View Product</a>
                    </div>
                  </div>
                </div>
              ))}
