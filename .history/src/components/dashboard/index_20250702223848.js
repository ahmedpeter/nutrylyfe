              ...
              <div class="col-xl-4 col-md-6">
                  <div class="ms-card card-linkedin ms-widget ms-infographics-widget">
                    <div class="ms-card-body media">
                      <div class="media-body">
                        <h6>My Wallet</h6>
                        <p class="ms-card-change"> <i class="material-icons">arrow_upward</i> {currency(userInfo?.wallet)}</p>
                        <p class="fs-9 mt-7">See more</p>
                      </div>
                    </div>
                    <i class="fab fa-twitter-square"></i>
                  ...
                  <div class="ms-card card-linkedin ms-widget ms-infographics-widget">
                    <div class="ms-card-body media">
                      <div class="media-body">
                        ...
                        <p class="ms-card-change"> <i class="material-icons">arrow_upward</i> {currency(userInfo?.pv)}</p>
                        <p class="fs-9 mt-7">See more</p>
                      </div>
                    </div>
                    <i class="fab fa-twitter-square"></i>
