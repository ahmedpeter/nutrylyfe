    ...
    <section>
      <div class="col-md-12">
        <div class="ms-panel">
          ...
          {userInfo?.user.user.user_type === "StockNetworkerist" && (
            <div class="row">
...
{userInfo?.user.user.user_type === "Stockist" && availableProducts?.length > 0 && (
          <div class="col-xl-12 col-md-12">
            <div class="ms-panel ms-panel-fh ms-crypto-orders">
              <div class="ms-panel-header">
                <div class="d-flex justify-content-between">
                      ...
                      <table class="table table-hover thead-primary">
                        ...
                        {availableProducts?.map((product, i) => (
                          <tr key={product.id}>
                            ...
                            <td>{product.status === "1" ? <span class="badge badge-success">Available</span> : <span class="badge badge-danger">Not Available</span>}</td>
                            {/* <td> 
