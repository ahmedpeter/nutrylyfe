...
const Dashboard = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      product: Yup.string().required("Full name is required"),
      pv: Yup.string().required("Username is required"),
      quantity: Yup.string().required("Placement ID is required"),
      availability: Yup.string().required("Binary position is required"),
    }),
        ...
        >
          <div className="modal-content">
            <div className="modal-body">
              ...
              <p>{isEditMode ? "Update Status of This Product" : "Add NNew Product"} </p>
