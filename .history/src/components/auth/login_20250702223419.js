...
const Login = () => {
        ...
        dispatch(
          setUser({
            user: {
              ...
              wallet: response.data.data.user.wallet.amount,
  ...
  <a class="pl-0 ml-0 text-center" href="index.html"> <img src="../../../Nutry_nameLogo.png" alt="NutryLyfe"/> </a>
                      ...
                      <div class="modal-body text-center">
                        ...
                        <form onSubmit={forgotPasswordFormik.handleSubmit}>
                          <div class="ms-form-group has-icon">
                            <input type="text" placeholder="Email Address" class="form-control" name="email" id="email" onChange={forgotPasswordFormik.handleChange}
      ...
      <div className="text-danger">{forgotPasswordFormik.errors.email}</div>
                          ...
                          <button type="submit" class="btn btn-primary shadow-none"> {loading ? "Sending..." : "Reset Password"}</button>
                        </form>
                      </div>
