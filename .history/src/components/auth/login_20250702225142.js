...
{showPassword ? 
            <span onClick={togglePassword} className="cnwjien mdi mdi-eye-outline mdi-18px text-muted my-5px"></span>
              : <span onClick={togglePassword} className="cnwjien mdi mdi-eye-off-outline mdi-18px text-muted my-5px"></span>}
