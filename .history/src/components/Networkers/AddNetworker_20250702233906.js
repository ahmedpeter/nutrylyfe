          ...
          <form class="needs-validation clearfix">
                <div class="form-row" style={{marginTop: "5%"}}>
                  ...
                  <div class="col-xl-6 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="" data-original-title="Parent member ID">Placement Member Id </label>
                    <div class="input-group">
                    <input type="text" class="form-control" id="validationCustom17" placeholder="NL - 123456" required/>
                  ...
                  <div class="col-xl-6 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="" data-original-title="Where do you want to place this member?">Binary Position </label>
                    <div class="input-group">
                      <select class="form-control" id="validationCustom15" required="">
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="" data-original-title="3 digit number at the back of your card">Select Package Type </label>
                    <div class="input-group">
                      <select class="form-control" id="validationCustom15" required="">
                        <option value="">Select an option</option>
                        {packageList?.length > 0 &&
                            packageList?.map((item) => (
                            <option value={package.id}> {item.name} - ({currency(item.price)}) </option>
                        ))}
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">Please provide an Email</label>
                    <div class="input-group">
                      <input type="email" class="form-control" id="validationCustom17" placeholder="email@faker.com" required=""/>
                    </div>
                  </div>
                  <div class="col-xl-4 col-md-12">
